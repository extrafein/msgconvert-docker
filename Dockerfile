...
RUN apk update && \
    apk add --no-cache wget perl perl-mail-tools perl-mime-types perl-email-simple perl-email-messageid perl-email-mime-encodings perl-email-mime-contenttype perl-email-address-xs perl-email-address-doc
